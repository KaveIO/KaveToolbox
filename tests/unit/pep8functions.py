...
class TestFunctions(unittest.TestCase):
    ...
    Except for the function runTest inherited from the underlying library, of course!
    """
    re = re.compile("\s*def *[a-z,_,0-9]*([A-Z])[a-z,A-Z,_,0-9]*\(")
    ignorefiles = ['pep8functions.py']
    ignorefunctions = ["def runTest", "def repoURL", "def fromKPMGrepo",
                       "def TH1D", "def TH2D", "def US_map"]
