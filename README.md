...
CentOS6, CentOS7 and Ubuntu 12->14 are used for testing, although no guarantees are given.
...
* 1: Installing the released version, for example, 1.1-Beta
```
yum -y install wget cur tar zip unzip gzip
wget http://repos:kaverepos@repos.kave.io/noarch/KaveToolbox/1.1-Beta/kavetoolbox-installer-1.1-Beta.sh
sudo bash kavetoolbox-installer-1.1-Beta.sh [--quiet]
```
